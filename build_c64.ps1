...
$viceC64  = "C:\Program Files\GTK3VICE-3.10-win64\bin\x64sc.exe"
...
& "$cl65Path" -t c64 .\adventure_engine.c  -Ln game.lbl -o game.prg
...
Write-Host "Launching VICE C64..." -ForegroundColor Yellow
& "$viceC64" -8 "$diskImage"
